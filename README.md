...
Set Permision
    ...
    chown root:root /srv/docker-composes/elastic-stack-docker/filebeat.yml
    chmod go-w /srv/docker-composes/elastic-stack-docker/filebeat.yml
...
Set Permision
    ...
    chown root:root /srv/docker-composes/elastic-stack-docker/kibana.yml
    chmod go-w /srv/docker-composes/elastic-stack-docker/kibana.yml
...
Test Elastic
    ...
    curl -XGET -k -u *:* https://localhost:9200
